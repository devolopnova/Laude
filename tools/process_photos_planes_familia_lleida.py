"""Procesa las 15 fotos de "Planes en familia - Lleida" (originales en
images/planes-familia/lleida/*.jpg, descargadas de Pexels) a WebP,
...
Uso: python tools/process_photos_planes_familia_lleida.py
"""
import pathlib
from PIL import Image

SRC = pathlib.Path(__file__).resolve().parent.parent / "images/planes-familia/lleida"
SHORT_SIDE = 1000
...
FILES = [
    ...
    "conca-della.jpg",
    "dinosfera.jpg",
    "estany-ivars-vila-sana.jpg",
    "granja-pifarre.jpg",
    "museu-lleida.jpg",
    "museu-roda-roda.jpg",
    "parc-astronomic-montsec.jpg",
    "parc-magic-almenar.jpg",
    "parc-mitjana.jpg",
    "seu-vella.jpg",
    "tren-dels-llacs.jpg",
]

...
with open('tools/output/planes-familia/asturias/plan.json', encoding='utf-8') as f:
    plan = json.load(f)

wb = Workbook()
ws = wb.active
ws.title = "Plan Asturias"
...
wb.save('tools/output/planes-familia/asturias/plan.xlsx')
print("saved")
